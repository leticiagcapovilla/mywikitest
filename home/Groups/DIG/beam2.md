...
$$
=log\left(\left (\frac{\cancel{\sqrt{\color{red}T_1 \cdot T_2}} \cdot \cancel{\sqrt\color{blue}T_3 \cdot T_4}}{\cancel{\sqrt{\color{blue}T_3 \cdot T_4}} \cdot \cancel{\sqrt{\color{red}T_1 \cdot T_2}}} \right ) \cdot (\left (\frac{\sqrt{A^2} \cdot \sqrt{D^2}}{\sqrt{B^2} \cdot \sqrt{C^2}}\right) \cdot K_x
$$