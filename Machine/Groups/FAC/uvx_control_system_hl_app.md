...
The UVX control system high level applications run on Windows and are mostly written in Delphi. The source code is available in [[FAC:FAC#UVX-HLA repo|repositories]] in the lnls82-linux workstation.
