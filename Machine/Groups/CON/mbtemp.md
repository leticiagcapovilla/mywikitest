...
For serial communication, the standard chosen by Controls Group is also adopted (described [CON:SERIALxxCON|here](/Machine/Groups/CON/mbtemp/link)).
...
Communication through [\[CON:MBTemp#BSMP\_entities|BSMP protocol and entities\]](/Machine/Groups/CON/mbtemp/link). You can have more information about variables in next section and about [BSMP protocol](/Machine/Groups/CON/bsmp) in a dedicated page.
...
ReadTemperature=ADvaluek−bRead Temperature = \\frac{ADvalue}{k} - b ReadTemperature=kADvalue​−b
...
α=(Byte\[1\]<<8)+Byte\[0\]\\alpha = (Byte\[1\] << 8) + Byte\[0\] α=(Byte\[1\]<<8)+Byte\[0\]
...
Temperature=−R0BR02B2−4AR0(0.388∗Traw+100.03−R0)2AR0Temperature = \\frac{-{R\_0}{B}\\sqrt{R\_0 ^2 B^2 - 4A R\_0 (0.388\*T\_{raw} + 100.03 - R\_0)}}{2A{R\_0}} Temperature=2AR0​−R0​BR02​B2−4AR0​(0.388∗Traw​+100.03−R0​)​​